...
export default function LoginScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.eyebrow}>UK TAXI · DRIVER</Text>
      <Text style={styles.title}>Sign in to go online</Text>
      <Text style={styles.sub}>We'll text a 6-digit code to your registered number.</Text>
      ...
      <Pressable onPress={() => navigation.navigate('Enrolment')} style={styles.enrolLink}>
        <Text style={styles.enrolLinkText}>New driver? Start enrolment →</Text>
      </Pressable>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.text, fontSize: 27, fontWeight: '700', marginBottom: 8 },
  ...
  enrolLink: { marginTop: 24, alignItems: 'center' },
  enrolLinkText: { color: colors.textDim, fontFamily: 'monospace', fontSize: 12.5 },
});
